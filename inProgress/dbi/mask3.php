...
<head>
    ...
    <title>Surgical N95 Respirators</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="text">
            <div>
                <h4><strong>Surgical N95 Respirators</strong></h4>
            </div>
            <div class="price_background">
                <div class="price">
                    <strong>Price: &nbsp;</strong> &nbsp &nbsp &nbsp &nbsp  <strong class="price_color">&#36 23.99 </strong>/Pc
                </div>
            </div>
            ...
            <form action="" method="POST">
                <div class="sold">
                    ...
                    <!-- <input type="text" name="numOfsoldmonth"> -->
                </div>
