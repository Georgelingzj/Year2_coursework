    ...
    try {
        ...
        if($userType == "customer")
        {
            ...
            // $conn->prepare("INSERT INTO customer VALUES (null,?,?,?,?,?,?)")->execute($data);
                $sqlForadd = "INSERT INTO cw2test1.customer VALUES(null, '$userName', '$realname', '$passport', '$telephone', '$email','$region','$passWord')";
        ...
        elseif ($userType == "reps") 
        {
            ...
            {
                // add rep user
                $sqlForadd = "INSERT INTO cw2test1.rep VALUES(null, '$userName', '$realname', '$telephone', '$email','$passWord')";
                $conn->query($sqlForadd);
                // set session and return to index page
                $_SESSION['userName'] = $userName;
                $_SESSION['password'] = $passWord;
