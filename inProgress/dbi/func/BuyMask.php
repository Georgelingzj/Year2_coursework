...
if ( ( $_SESSION['userName'] != null ) ) {
    ...
    try {
        ...
        if ($_SESSION['type'] == 4) {
            ...
            $sqlForMaskType = "SELECT maskType1Num, maskType2Num, maskType3Num FROM cw2test1.costomerordertotal WHERE cOrderID = '$orderid';";
            ...
            if ($maskType1NumForCancel >0 ) {
                ...
                if (($conn->query($sqlForUpdateStorage1))&&($conn->query($sqlFororderstatus))) {
                    $conn = NULL;
                }
                else{
                    $conn = NULL;
            ...
            if ($maskType2NumForCancel >0 ) {
                ...
                if ($conn->query($sqlForUpdateStorage2)) {
                    $conn = NULL;
                }
                else{
                    $conn = NULL;
            ...
            if ($maskType3NumForCancel >0 ) {
                ...
                if ($conn->query($sqlForUpdateStorage3)) {
                    $conn = NULL;
                }
                else{
                    $conn = NULL;
        ...
        else
        {
            ...
            $isComplete = ($conn->query($sqlForAssignCustomer))&&($conn->query($sqlForUpdateQuota));
            if ($isComplete != 0) {
